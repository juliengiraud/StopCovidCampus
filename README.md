...
Rapport après ajout d'une balise ```html <meta name="viewport">``` pour contrôler la mise en page sur les navigateurs mobiles.
...
Rapport après ajout d'une balise ```htlm <meta name="description">``` pour contrôler la mise en page sur les navigateurs mobiles.
